...
const LoginForm = ({ show, onSubmit, onChange }) => (
  <div className={`tab-pane ${show ? 'selected' : ''}`} id="login">
      <form encType="application/x-www-form-urlencoded" onSubmit={onSubmit}>
            <div className="form-row">
                ...
                <div className="alert error-flash errors hide-error" id="email-error"></div>
                <div className="row">
                    <input
                      type="text"
                ...
                <p className="login-small-signup">or <span><a href="#">Sign up</a></span></p>
            </div>
      </form>
  </div>
);
